                        ...
                        <div class = "panel-body">
                            <div class="box text-shadow">
                                ...
                                if(isset($_POST['submit-search'])){
                                        ...
                                        $Certificate_Provided = $_POST['Certificate_Provided'];
                                        $Teaching_Language = $_POST['Teaching_Language'];
                                    ...
                                    if ($One == ''){ echo '<h3><b>Please type in your ideal course name first in the search bar</b></h3>';}
                                    //echo $search.'+'. $Certificate_Provided .'+'. $Teaching_Language .'+'.$Location; 
                                    //echo "SELECT * FROM Course WHERE $One $Two $Three $Four";
                                    $sql = "SELECT * FROM Course WHERE $One $Two $Three $Four";
                                    ...
                                    $sql2 = "SELECT * FROM Course WHERE $One $Two $Three $Four $limit";
                                ...
                                ?>
                                   ...
                                   <p><strong><?php echo $queryResults; ?></strong> results for ' <?php echo $outputSearch .' | '.$outputTeaching_Language .' | '.$outputLocation; ?> '</p>
