                        ...
                        <div class = "panel-body">
							<div class="box text-shadow">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM Job ORDER BY $option DESC";
                                    ...
                                    $sql2 = "SELECT * FROM Job ORDER BY $option DESC $limit";
                                ...
                                ?>
                                    ...
                                    <p><strong><?php echo $queryResults; ?></strong> jobs found, order by <b><?php echo $userSelect; ?></b> </p>
                                    <?php
                                    if ($queryResults > 0){
