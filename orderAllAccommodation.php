...
<?php error_reporting(0); ?>
    ...
    $pageTitle = 'look_for_accommodation_order';
?>
        <!--BEGIN PAGE WRAPPER-->
                        ...
                        <div class = "panel-body">
							<div class="box text-shadow">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM Accommodation ORDER BY $option";
                                    ...
                                    $sql2 = "SELECT * FROM Accommodation ORDER BY $option $limit";
                                ...
                                ?>
                                    ...
                                    <p><strong><?php echo $queryResults; ?></strong> accommodations found, order by <b><?php echo $userSelect; ?></b> </p>
                                    <?php
                                    if ($queryResults > 0){
